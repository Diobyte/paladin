...
local menu_elements =
{
    ...
    targeting_mode      = combo_box:new(0, get_hash(my_utility.plugin_label .. "rally_targeting_mode")),
    min_target_range    = slider_float:new(1, max_spell_range - 1, 3,
        get_hash(my_utility.plugin_label .. "rally_min_target_range")),
}
...
local function logics(target)
    ...
    if cast_spell.self(spell_data.rally.spell_id, 0) then
        ...
        console.print("Cast Rally - Target: " ..
