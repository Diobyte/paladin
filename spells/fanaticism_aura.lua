...
-- Constants
local AURA_DURATION = spell_data.fanaticism_aura.duration or 12.0
...
local buff_id = spell_data.fanaticism_aura.buff_id
local buff_name_patterns = spell_data.fanaticism_aura.buff_name_patterns or {"fanatic", "fanaticism"}
...
local function logics()
    ...
    if cast_spell.self(spell_id, 0.0) then
        ...
        if debug_enabled then
            console.print("[FANATICISM DEBUG] Cast Fanaticism Aura")
        end
