...
local menu_elements =
{
    ...
    is_independent      = checkbox:new(false, get_hash(my_utility.plugin_label .. "defiance_aura_is_independent")),
}
...
local function logics()
    ...
    if my_utility.is_spell_active(spell_data.defiance_aura.spell_id) then
        return false
    end
