describe("my_target_selector.get_most_hits_circular (busted)", function()
    local ts
    ...
    it("returns invalid when no hits", function()
        ...
        assert.is_false(area2.is_valid)
    end)
end)
